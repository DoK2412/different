...
# тут мы определяем повсчет требуемых параметров и вспомогательные инструменты
...
with open((os.path.abspath(os.path.join('..', '02_zen_of_python', 'zen.txt'))), 'r', encoding='utf-8') as zen:
